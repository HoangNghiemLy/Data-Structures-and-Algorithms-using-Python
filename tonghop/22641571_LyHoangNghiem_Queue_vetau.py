...
while True:
    os.system("cls")
    print("1. Thêm một khách hàng mới vào cuối hàng đợi mua vé.")
    ...
    if chon == 1:
        ...
        l.themvaocuoi(KhachHangMuaVe(cmnd,ten,gaden,giave))
    elif chon == 2:
        cmnd = input("Nhập số CMND: ")
        tmp = pHead
        while tmp != None:
